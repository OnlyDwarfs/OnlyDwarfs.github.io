...
const FinalCTA = () => (
  <section className="od-final-cta" data-screen-label="Final CTA">
    ...
    <div className="od-inner od-text-center">
      ...
      <p className="od-final-sub">Quote in 24 hours. No commitment. Real humans, real talent, real show.</p>
      <div className="od-final-actions">
        <a href="intake.html" className="od-btn-primary od-btn-lg">Request a quote →</a>
        <a href="mailto:bookings@onlydwarfs.com" className="od-btn-outline od-btn-lg">Email the team</a>
      </div>
