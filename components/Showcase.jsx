      ...
      <div className="od-inner">
        <div className="od-showcase-grid">
          <div className="od-showcase-left">
            ...
            <h2 className="od-showcase-title">Dwarf<span className="od-accent-blue">Divas</span></h2>
            <p className="od-showcase-tagline">Our house show. Top performers, one stage, two nights only.</p>
            <p className="od-showcase-desc">May 28 &amp; 29 at Deja Vu Showgirls. Comedy, music, attitude. The most unique night out in Las Vegas — and the only one you can also book privately.</p>
          ...
          <div className="od-showcase-right">
            <div className="od-showcase-ticket">
              <div className="od-showcase-ticket-head"><span>Deja Vu Showgirls</span><span className="od-showcase-ticket-date">Thu 28 · Fri 29</span></div>
              <div className="od-showcase-countdown">
                <div className="od-cd-block"><span className="od-cd-num">{countdown.d}</span><span className="od-cd-lbl">Days</span></div>
                <div className="od-cd-sep" /><div className="od-cd-block"><span className="od-cd-num">{String(countdown.h).padStart(2,'0')}</span><span className="od-cd-lbl">Hours</span></div>
                <div className="od-cd-sep" /><div className="od-cd-block"><span className="od-cd-num">{String(countdown.m).padStart(2,'0')}</span><span className="od-cd-lbl">Min</span></div>
              </div>
              <div className="od-showcase-meter">
                <div className="od-showcase-meter-label"><span>Tickets remaining</span><span className="od-showcase-meter-value">62 / 180</span></div>
                <div className="od-showcase-meter-track"><div className="od-showcase-meter-fill" style={{ width: '65%' }} /></div>
